    ...
    <div id="consoleRow">
      <div class="panel panel-default" id="consoleContent">
        <div class="panel-heading">
          <h3 class="panel-title pull-left"><span class="glyphicon glyphicon-console"></span> 控制台</h3>
          <div class="btn-group btn-group-xs pull-right">
            <a class="btn btn-default" href="../server_manager.php" target="_blank"><span class="glyphicon glyphicon-question-sign"></span><span class="hidden-xs"> 返回服务器列表</span></a>
            <a class="btn btn-default" href="https://github.com/Rauks/Minecraft-RCON" target="_blank"><span class="glyphicon glyphicon-info-sign"></span><span class="hidden-xs"> 原项目的Github</span></a>
          </div>
        </div>
      ...
      <div class="input-group" id="consoleCommand">
        ...
        <div class="input-group-btn">
          <button type="button" class="btn btn-primary" id="btnSend"><span class="glyphicon glyphicon-send"></span><span class="hidden-xs"> 发送</span></button>
          <button type="button" class="btn btn-warning" id="btnClearLog"><span class="glyphicon glyphicon-erase"></span><span class="hidden-xs"> 清除</span></button>
        </div>
      </div>
    </div>
  </div>
